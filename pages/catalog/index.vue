...
const { collection } = storeToRefs(useCartStore());
...
const toggleFilterMenu = () => {
  return (isOpenFilter.value = !isOpenFilter.value);
};
</script>
<template>
  <div class="flex flex-col">
    <div class="self-center w-[90%] max-md:w-full">
    ...
    <div class="flex flex-col">
      <div
        class="flex justify-between items-center gap-4 text-center lg:justify-end"
      >
        <button
        ...
        <div
          class="relative self-end flex items-center mb-6 w-2/5 max-sm:w-full"
        >
          <input
